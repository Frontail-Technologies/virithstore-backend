    ...
    await db.insert(products).values([
      {
        ...
        type: "account",
        description: "Official Ultra HD 4K Netflix streaming profile with personal PIN lock, unlimited movies & TV shows, multi-language audio, and guaranteed replacement warranty.",
        guide: "Use the email and password provided in your order invoice to login directly at netflix.com or on your Smart TV / mobile app. Select your assigned profile name and enter your private PIN.",
        categoryId: streamId,
        image: "/images/products/netflix.jpg",
        banner: "/images/products/netflix.jpg",
        slides: [
          "/images/products/netflix.jpg"
        ],
        isPopular: true,
        isHot: true,
        isFeatured: true,
      ...
      },
      {
        ...
        banner: "/images/products/spotify.jpg",
        slides: ["/images/products/spotify.jpg"],
        isPopular: true,
        isHot: false,
        isFeatured: true,
        isAvailable: true,
      ...
      },
      {
        ...
        banner: "/images/products/chatgpt.jpg",
        slides: ["/images/products/chatgpt.jpg"],
        isPopular: true,
        isHot: true,
        isFeatured: true,
        isAvailable: true,
      ...
      },
      {
        ...
        banner: "/images/products/youtube.jpg",
        slides: ["/images/products/youtube.jpg"],
        isPopular: true,
        isHot: false,
        isFeatured: true,
        isAvailable: true,
      ...
      },
      {
        ...
        banner: "/images/products/discord.jpg",
        slides: ["/images/products/discord.jpg"],
        isPopular: true,
        isHot: true,
        isFeatured: true,
        isAvailable: true,
      ...
      },
      {
        ...
        banner: "/images/products/canva.jpg",
        slides: ["/images/products/canva.jpg"],
        isPopular: false,
        isHot: false,
        isFeatured: true,
        isAvailable: true,
